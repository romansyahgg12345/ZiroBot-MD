...
global.mods = []
global.prems = []
global.nomorbot = '628xxxxxxx' // ubah nomer BOT lu
global.nameown = 'ZiroBotz-MD' // Ubah Nama Owner lu
global.nomorown = '6281228070013' // ubah no owner lu
...
global.author = 'Ziro-MD' //ganti aja cuyyy
global.namebot = 'Ziro-Md' //nama bot luh
global.wm = '© Ziro-Md' //ganti aja
global.media = 'https://telegra.ph/file/5d45a3d1e12726d98c5e4.jpg' //bebas
global.wm = 'Ziro-Md ' //wm nyaa kocak
global.watermark = wm //bebas
global.wm2 = 'Ziro-MD' //ganti ajaa 
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`//ga usah dehhh 
global.bottime = `T I M E : ${wktuwib}` //ini juga ga usah 
global.titlebot = 'Ziro-Md | PutraModz` //gantu aja
global.stickpack = 'Ziro-Modz' //ganti 
global.stickauth = `© Ziro-Md` //gantii 
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= 'Ziro-MD Official' //ganti 
global.nameown2 = 'Ziro-MD' //ganti 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
